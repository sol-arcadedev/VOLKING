...
import {REWARD_FEATURES} from '../constants';
          ...
          <div className="text-center">
            ...
            <div className="pixel-box p-6 mb-8 max-w-3xl mx-auto">
              ...
              <p className="text-retro-white font-body text-base leading-relaxed mb-4">
                VOLKING is the ultimate volume-based reward token! Every 15 minutes, the trader who generates the <span className="text-candle-green font-bold">highest volume</span> becomes the VOLKING and claims the prize pool. It's simple: trade smart, and claim your throne!
              </p>
            </div>
